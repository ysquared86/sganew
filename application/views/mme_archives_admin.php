...
<table class="sga-table">
	...
	?>
		<tr class="<?php echo $evenodd; ?>">
			...
			<td><?php echo anchor('admin/single_issue/'.$issue->id, 'View') . ' | ' . anchor('admin/mme_emailview/'.$issue->id, 'E-mail Version', 'target="_blank"') . ' | ' . anchor('admin/manage_mmes/delete/'.$issue->id, 'Delete');?></td>
		</tr>
	<?php
			$i++;
		}
