...
/* This most probably won't work in all email clients. Don't include <code _tmplitem="775" > blocks in email. */
code {
  white-space: normal;
...
.header-content { font-size: 13px; color: #888888; }
.header-content a { font-weight: bold; color: #eeeeee; text-decoration: none; }
#headline p { color: #eeeeee; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; font-size: 30px; text-align: center; margin-top:0px; margin-bottom:30px; }
#headline p a { color: #eeeeee; text-decoration: none; }
.article-title { font-size: 15px; line-height:24px; color: #3d3d3d; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; }
.article-title a { color: #3d3d3d; text-decoration: none; }
.article-title.with-meta {margin-bottom: 0;}
.article-meta { font-size: 11px; line-height: 20px; color: #ccc; font-weight: bold; margin-top: 0;}
...
.article-content li { font-size: 12px; line-height: 18px; color: #444444; }
.article-content li a { color: #2f82de; text-decoration:underline; }
.article-content p {margin-bottom: 15px;}
.footer-content-left { font-size: 11px; line-height: 15px; color: #888888; margin-top: 0px; margin-bottom: 15px; }
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="background-table">
	<tbody>
		<tr>
			<td align="center" bgcolor="#c7c7c7">
                ...
                <tr>
                <td id="header" class="w640" width="640" align="center" bgcolor="#CC0000">
        ...
        <tr>
            ...
            <td class="w580" width="580">
                <div align="center" id="headline">
					<p style="font-size: 30px; font-weight: bold; color: #EEEEEE; margin-bottom: 12px; text-decoration: none;">Monday Morning E-mail</p>
					<p style="font-size: 18px; font-weight: bold; color: #CCCCCC;">Week of <?php echo date('F d, Y', $issue->firstmonday); ?></p>
                </div>
            </td>
            <td class="w30" width="30"></td>
        </tr>
        ...
        <tbody><tr>
            ...
            <td class="w580" width="580">
                <repeater>
                        ...
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
									<a name="top"></a>
                                    <div align="left">
										<p style="font-weight: bold;">What's in this edition?</p>
										<ol style="font-size: 13px; padding-left: 25px;" class="article-content">
											<?php foreach( $issue->entries_sga as $entry ) { ?>
												<li style="margin-bottom: 5px;"><a style="font-size: 13px;" href="#<?php echo 'mme-'.$entry->id; ?>"><?php echo $entry->title; ?></a></li>
											<?php } ?>
					...
					<!-- Entries -->
					<hr style="color: #CC0000; background-color: #CC0000; height: 5px;" />
					<?php if(!empty($issue->entries_sga)) { ?>
							<layout label="Text only">
								<table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
									<tbody><tr>
										<td class="w580" width="580">
											<p align="center" class="article-title" style="color: #CC0000; font-size: 17px; font-weight: bold; margin-top: 13px;"><singleline label="Title">Student Government Association</singleline></p>
										</td>
									</tr>
									<tr><td class="w580" width="580" height="10"></td></tr>
								</tbody></table>
							</layout>
							<?php $issue->print_entries_email( 'sga' ); ?>
							<hr style="color: #CC0000; background-color: #CC0000; height: 5px;" />
					<?php } ?>
					
					<?php if(!empty($issue->entries_this_week)) { ?>
							<layout label="Text only">
								<table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
									<tbody><tr>
										<td class="w580" width="580">
											<p align="center" class="article-title" style="color: #CC0000; font-size: 17px; font-weight: bold; margin-top: 13px;"><singleline label="Title">This Week</singleline></p>
										</td>
									</tr>
									<tr><td class="w580" width="580" height="10"></td></tr>
								</tbody></table>
							</layout>
							<?php $issue->print_entries_email( 'this_week' ); ?>
							<hr style="color: #CC0000; background-color: #CC0000; height: 5px;" />
					<?php } ?>
					...
					<?php if(!empty($issue->entries_next_week)) { ?>
							<layout label="Text only">
								<table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
									<tbody><tr>
										<td class="w580" width="580">
											<p align="center" class="article-title" style="color: #CC0000; font-size: 17px; font-weight: bold; margin-top: 13px;"><singleline label="Title">Next Week</singleline></p>
										</td>
									</tr>
									<tr><td class="w580" width="580" height="10"></td></tr>
								</tbody></table>
							</layout>
							<?php $issue->print_entries_email( 'next_week' ); ?>
							<hr style="color: #CC0000; background-color: #CC0000; height: 5px;" />
					<?php } ?>
					...
					<?php if(!empty($issue->entries_overrides)) { ?>
							<layout label="Text only">
								<table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
									<tbody><tr>
										<td class="w580" width="580">
											<p align="center" class="article-title" style="color: #CC0000; font-size: 17px; font-weight: bold; margin-top: 13px;"><singleline label="Title">Miscellaneous</singleline></p>
										</td>
									</tr>
									<tr><td class="w580" width="580" height="10"></td></tr>
								</tbody></table>
							</layout>
							<?php $issue->print_entries_email( 'overrides' ); ?>
							<hr style="color: #CC0000; background-color: #CC0000; height: 5px;" />
					<?php } ?>
                        ...
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <div align="left" class="article-content">
                                        <multiline label="Description">
										<p><span style="font-weight: bold;">Again, if you have any questions about the SGA, please write to <?php echo mailto('sgalaw@bu.edu'); ?></span>. If you would like to submit to the Monday Morning E-mail, please register <?php echo anchor('login/signup', 'here'); ?>. Remember, <span style="font-weight: bold;">all submissions are due by <u>5pm on Sunday</u></span>.</p>
    ...
    <table id="footer" class="w640" width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#000000">
        <tbody><tr><td class="w30" width="30"></td><td class="w580 h0" width="360" height="10"></td><td class="w0" width="60"></td><td class="w0" width="160"></td><td class="w30" width="30"></td></tr>
        <tr>
            <td class="w30" width="30"></td>
